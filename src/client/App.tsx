...
const publicDemoSnapshot: BoardData = {
  board: {
    ...
    name: 'AcmeFlow Product Roadmap',
    slug: 'vercel-production-feedback',
    organizationName: 'AcmeFlow — Fictional Demo Workspace',
  },
  posts: [
    {
      id: 'demo-slack-capture',
      title: 'Slack request capture',
      description: 'Turn selected Slack conversations into organized feedback without copying and pasting every detail.',
      status: 'in_progress',
      authorName: 'AcmeFlow Product Team',
      voteCount: 1,
      commentCount: 1,
      comments: [{ id: 'demo-comment-slack', body: 'The first version will support one workspace and preserve the original message link.', authorName: 'AcmeFlow Product Team' }],
      statusHistory: [
        { status: 'under_review', createdAt: '2026-05-12T14:00:00.000Z' },
        { status: 'planned', createdAt: '2026-06-03T14:00:00.000Z' },
        { status: 'in_progress', createdAt: '2026-07-08T14:00:00.000Z' },
      ],
      createdAt: '2026-05-12T14:00:00.000Z',
    },
    {
      id: 'demo-duplicate-detection',
      title: 'Duplicate suggestion detection',
      description: 'Suggest related requests before a customer publishes another version of the same idea.',
      status: 'under_review',
      authorName: 'AcmeFlow Product Team',
      voteCount: 1,
      commentCount: 1,
      comments: [{ id: 'demo-comment-duplicates', body: 'We are testing matching quality before deciding whether suggestions should appear during typing or after submission.', authorName: 'AcmeFlow Product Team' }],
      statusHistory: [{ status: 'under_review', createdAt: '2026-06-18T14:00:00.000Z' }],
      createdAt: '2026-06-18T14:00:00.000Z',
    },
    {
      id: 'demo-categories',
      title: 'Custom feedback categories',
      description: 'Organize requests by product area so customers and teams can filter the roadmap more quickly.',
      status: 'planned',
      authorName: 'AcmeFlow Product Team',
      voteCount: 1,
      commentCount: 1,
      comments: [{ id: 'demo-comment-categories', body: 'Workspace owners will control the category list and default ordering.', authorName: 'AcmeFlow Product Team' }],
      statusHistory: [
        { status: 'under_review', createdAt: '2026-04-22T14:00:00.000Z' },
        { status: 'planned', createdAt: '2026-06-27T14:00:00.000Z' },
      ],
    ...
    },
    {
      ...
      description: 'Send a concise summary of newly planned, in-progress, and shipped features to subscribed teammates.',
      status: 'planned',
      authorName: 'AcmeFlow Product Team',
      voteCount: 1,
      commentCount: 1,
      comments: [{ id: 'demo-comment-digest', body: 'Digest delivery will be opt-in and grouped by workspace.', authorName: 'AcmeFlow Product Team' }],
      statusHistory: [
        { status: 'under_review', createdAt: '2026-05-30T14:00:00.000Z' },
        { status: 'planned', createdAt: '2026-07-01T14:00:00.000Z' },
      ],
    ...
    },
    {
      ...
      description: 'Import customer contacts with field mapping, duplicate checks, and a preview before changes are saved.',
      status: 'shipped',
      authorName: 'AcmeFlow Product Team',
      voteCount: 1,
      commentCount: 1,
      comments: [{ id: 'demo-comment-csv', body: 'Shipped with downloadable error rows for records that need attention.', authorName: 'AcmeFlow Product Team' }],
      statusHistory: [
        { status: 'under_review', createdAt: '2026-03-05T14:00:00.000Z' },
        { status: 'planned', createdAt: '2026-03-28T14:00:00.000Z' },
        { status: 'in_progress', createdAt: '2026-05-06T14:00:00.000Z' },
        { status: 'shipped', createdAt: '2026-06-14T14:00:00.000Z' },
      ],
      createdAt: '2026-03-05T14:00:00.000Z',
    },
    {
      id: 'demo-dark-mode',
      title: 'Dark mode and theme controls',
      description: 'Let each user choose light, dark, or system appearance while preserving accessible contrast.',
      status: 'shipped',
      authorName: 'AcmeFlow Product Team',
      voteCount: 1,
      commentCount: 1,
      comments: [{ id: 'demo-comment-theme', body: 'Theme preference now follows each user across devices.', authorName: 'AcmeFlow Product Team' }],
      statusHistory: [
        { status: 'under_review', createdAt: '2026-02-17T14:00:00.000Z' },
        { status: 'planned', createdAt: '2026-03-12T14:00:00.000Z' },
        { status: 'in_progress', createdAt: '2026-04-09T14:00:00.000Z' },
        { status: 'shipped', createdAt: '2026-05-20T14:00:00.000Z' },
      ],
